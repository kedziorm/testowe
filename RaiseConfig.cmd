@echo off
echo %username%
rem Script brings up an OmniCubes Config database version using scripts from VSDB Project
rem Takes one parameter - root directory of OmniCubes directory
rem
rem ex: RaiseConfigVersion C:\Users\dummmyuser\Projects\.net\ddi@mb\OmniCubes
rem 
...
set scriptslocation=%WORKSPACE%\OmniCubes.Database.Config\Scripts\UpdateScripts
...
set dbname=%PROJECT%Config
if /I NOT [%PROJECTTYPE%]==[Live] set dbname=%PROJECT%Config_%PROJECTTYPE%
...
set expectedDBtype=OmniCubesConfig
